...
class EarningsScreen extends StatelessWidget {
  ...
  Widget _buildOverviewCards() {
    return Row(
      children: [
        Expanded(
          child: _buildInfoCard('Total Earnings', '\$21,408', '.00'),
        ),
        const SizedBox(width: 16),
        Expanded(
          child: _buildInfoCard('Available For Withdraw', '\$12,723', '.32'),
        ),
      ],
    );
  }
      ...
      children: [
        Expanded(
          child: OutlinedButton(
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => const EditBankDetailsScreen()));
            },
            ...
            child: const Text('Edit Bank Details', style: TextStyle(color: AppColors.primaryRed, fontWeight: FontWeight.bold)),
          ),
        ),
        const SizedBox(width: 16),
        Expanded(
          child: ElevatedButton(
            ...
            child: const Text('Withdraw Earnings', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          ),
        ),
      ],
    );
